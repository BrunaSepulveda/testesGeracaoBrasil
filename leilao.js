...
export async function leilao () {
  const api = await axios.get('https://www.ccee.org.br/acervo-ccee?especie=38753&assunto=39056&keyword=consolidado&periodo=365')
  ...
  let planilhaObj = xlsx.parse(planilha).find((element) => element.name === 'Resultado Consolidado').data;
